...
- (instancetype)init
{
    ...
    /**
     *  Create avatar image 
     *  Be sure to create your avatars,
     *
     */
    JSQMessagesAvatarImage *jsqImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"me_64"]
    ...
    self.avatars = @{ kJSQDemoAvatarIDName : jsqImage,
                      kJSQDemoAvatarIDCook : cookImage,
                      kJSQDemoAvatarIDJobs : jobsImage,
                      kJSQDemoAvatarIDWoz : wozImage };
    
    
    self.users = @{ kJSQDemoAvatarIDJobs : kJSQDemoAvatarDisplayJobs,
                    kJSQDemoAvatarIDCook : kJSQDemoAvatarDisplayCook,
                    kJSQDemoAvatarIDWoz : kJSQDemoAvatarDisplayWoz,
                    kJSQDemoAvatarIDName : kJSQDemoAvatarDisplayName};
...
- (void)loadFakeMessages
{
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIDName
                                        senderDisplayName:kJSQDemoAvatarDisplayName
                                                     date:[NSDate distantPast]
                                                     text:@"Welcome to JSQMessages: A messaging UI framework for iOS."],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIDJobs
                                        senderDisplayName:kJSQDemoAvatarDisplayJobs
                                                     date:[NSDate distantPast]
                     ...
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIDCook
                                        senderDisplayName:kJSQDemoAvatarDisplayCook
                                                     date:[NSDate date]
    ...
    if ([NSUserDefaults longMessageSetting]) {
        JSQMessage *reallyLongMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIDName
                                                            displayName:kJSQDemoAvatarDisplayName
...
- (void)addPhotoMediaMessage
{
    ...
    JSQMessage *photoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIDName
                                                   displayName:kJSQDemoAvatarDisplayName
                                                         media:photoItem];
...
- (void)addLocationMediaMessageCompletion:(JSQLocationMediaItemCompletionBlock)completion
{
    ...
    JSQMessage *locationMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIDName
                                                      displayName:kJSQDemoAvatarDisplayName
                                                            media:locationItem];
...
- (void)addVideoMediaMessage
{
    ...
    JSQMessage *videoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIDName
                                                   displayName:kJSQDemoAvatarDisplayName
                                                         media:videoItem];
